...
def confirm_deletion(entity_type: str, entity_id: str) -> bool:
    ...
    for _ in range(0, MAX_RETRIES):
        ...
        if confirm_connector_id != entity_id:
            logger.error(f"Wrong {entity_type}, to confirm deletion, please type {entity_type} ID: '{[entity_id]}'")
            continue
        return True
...
def interactive_run(command_return, interactive: bool = False, **kwargs):
    ...
    shell.interact(
        banner="Babylon interactive mode.\n"

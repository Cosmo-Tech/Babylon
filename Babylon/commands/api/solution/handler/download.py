...
@option("-o", "--output", "output_folder", help="Output folder", type=Path(path_type=Path(exists=True, file_okay=True, dir_okay=False, readable=True, path_type=pathlib.Path)))

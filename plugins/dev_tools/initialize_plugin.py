...
@click.argument("plugin_folder",
                type=Path(file_okay=False, dir_okay=True, readable=True, writable=True, path_type=Path(exists=True, file_okay=True, dir_okay=False, readable=True, path_type=pathlib.Path)))

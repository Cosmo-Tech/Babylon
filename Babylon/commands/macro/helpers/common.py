"""
Shared helpers used across all macro commands.

Covers:
- ``include`` / ``exclude`` CLI option validation and resolution
- ACL diff computation
- Generic object-security synchronisation (organization, solution, workspace)
"""
...
def validate_inclusion_exclusion(
    ...
    allowed_values = ("build", "organization", "solution", "workspace", "webapp")
...
def resolve_inclusion_exclusion(
    ...
    Returns:
        tuple[bool, bool, bool, bool, bool]: flags to include build, organization, solution, workspace, webapp
    """
    ...
    return (build, organization, solution, workspace, webapp)

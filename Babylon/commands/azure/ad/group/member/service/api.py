...
class AzureDirectoyMemberService:
    ...
    def add(self, group_id: str, principal_id: str, azure_token: str):
    ...
    def get_all(self, group_id: str, azure_token: str):
    ...
    def remove(self, group_id: str, principal_id: str, azure_token: str):

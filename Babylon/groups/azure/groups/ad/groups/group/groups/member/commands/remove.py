...
def remove(group_id: str, service_principal_id: str, force_validation: bool = False) -> CommandResponse:
    ...
    response = oauth_request(route, get_azure_token("graph"), type="DELETE")
    if response is None:
        return CommandResponse.fail()

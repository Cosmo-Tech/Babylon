...
@argument("workspace_data_file", type=Path(path_type=click.Path(exists=True, file_okay=True, dir_okay=False, readable=True, path_type=pathlib.Path), exists=True, dir_okay=False))

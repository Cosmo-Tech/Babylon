...
@argument("pbix_filename", type=Path(readable=True, dir_okay=False, path_type=Path(exists=True, file_okay=True, dir_okay=False, readable=True, path_type=pathlib.Path)))
@option("-w",
        "--workspace",
        "workspace_id",

...
@output_to_file
def get(powerbi_workspace_id: str, dataset_id: str, workspace_id: Optional[str] = None) -> CommandResponse:
    ...
    response = oauth_request(update_url, get_azure_token("powerbi"))
    if response is None:
        return CommandResponse.fail()

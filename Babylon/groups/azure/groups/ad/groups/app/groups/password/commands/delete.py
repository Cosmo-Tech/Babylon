...
def delete(app_id: str, key_id: str, force_validation: bool = False) -> CommandResponse:
    """
    ...
    response = oauth_request(route, get_azure_token("graph"), type="POST", json={"keyId": key_id})
    if response is None:
        return CommandResponse.fail()

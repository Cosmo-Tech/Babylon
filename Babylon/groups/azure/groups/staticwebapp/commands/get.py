...
@argument("name")
def get(azure_subscription: str, resource_group_name: str, name: str) -> CommandResponse:
    """
    ...
    response = oauth_request(
        ...
        f"/providers/Microsoft.Web/staticSites/{name}?api-version=2022-03-01", get_azure_token())
    if response is None:

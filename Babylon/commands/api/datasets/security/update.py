...
def update(state: dict, config: dict, keycloak_token: str, identity_id: str, email: str, role: str, organization_id: str,
    ...
    logger.info(f"Updating user {[email]} RBAC access in the dataset {[services_state['dataset_id']]}")

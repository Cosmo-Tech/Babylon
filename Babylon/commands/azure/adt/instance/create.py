...
from .....utils.clients import pass_adt_management_client, get_azure_credentials
...
def create(
    ...
    scope = f'/subscriptions/{azure_subscription}/resourceGroups/{resource_group_name}/providers/Microsoft.DigitalTwins/digitalTwinsInstances/{adt_instance_name}'
    ...
    return CommandResponse.success({"adt_instance": adt_creation_result.name, "role_assignment": role_assignment})

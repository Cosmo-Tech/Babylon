...
def delete(workspace_id: str, force_validation: bool) -> CommandResponse:
    ...
    response = oauth_request(url=url_delete, access_token=get_azure_token("powerbi"), type="DELETE")
    if response is None:
        return CommandResponse.fail()

...
def take_over(powerbi_workspace_id: str, dataset_id: str, workspace_id: Optional[str] = None) -> CommandResponse:
    ...
    response = oauth_request(url, get_azure_token("powerbi"), type="POST")
    if response is None:
        return CommandResponse.fail()

...
@command()
@argument("template_path", type=Path(path_type=click.Path(exists=True, file_okay=True, dir_okay=False, readable=True, path_type=pathlib.Path), exists=True, dir_okay=False))
@option("-p", "--parameter", "params", type=(QueryType(), QueryType()), multiple=True)
@option("-o",
        "--output",
        "output_file",
        type=Path(path_type=click.Path(exists=True, file_okay=True, dir_okay=False, readable=True, path_type=pathlib.Path), dir_okay=False),
